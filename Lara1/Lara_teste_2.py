...
ticker = "PETR4"  # Atualize para o contrato vigente
lote = 1
stop_loss = 100  # Em pontos
take_profit = 300  # Em pontos
...
def backtest(df, modelo, scaler):
    """ Realiza o backtest no histórico e exibe a quantidade de dias de negociação """
